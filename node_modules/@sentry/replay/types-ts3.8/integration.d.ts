...
import { ReplayConfiguration, ReplayPluginOptions, SendBufferedReplayOptions } from './types';
type InitialReplayPluginOptions = Pick<ReplayPluginOptions, Exclude<keyof ReplayPluginOptions, 'sessionSampleRate' | 'errorSampleRate'>> & Partial<Pick<ReplayPluginOptions, 'sessionSampleRate' | 'errorSampleRate'>>;
export declare const replayIntegration: (options?: InitialReplayPluginOptions) => Replay;
/**
