...
import type { ReplayConfiguration, ReplayPluginOptions, SendBufferedReplayOptions } from './types';
type InitialReplayPluginOptions = Omit<ReplayPluginOptions, 'sessionSampleRate' | 'errorSampleRate'> & Partial<Pick<ReplayPluginOptions, 'sessionSampleRate' | 'errorSampleRate'>>;
